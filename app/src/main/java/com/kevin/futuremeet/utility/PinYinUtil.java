...
public class PinYinUtil {
    ...
    /**
     * change the chinese character in the input String to PinYin while leave anything else in it unchanged
     */
    ...
    /**
     * get the initial of the PinYin of the input string(Chinese)
     *
     * @param str
     * @return
     */
