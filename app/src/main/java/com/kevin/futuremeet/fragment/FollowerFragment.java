 ...
 */
public class FollowerFragment extends EndlessSwipeRefreshRecyclerviewFragment {
    ...
    void onBindNormalItemViewHolder(RecyclerView.ViewHolder holder,List<AVObject> dataList, int position) {
        ...
        final AVObject friendObj = fromUserObj.getAVObject(RelationShipContract.FROM);
    ...
    protected AVQuery<AVObject> initQueryBasic() {
        ...
        query.include(RelationShipContract.FROM);
        ...
        query.whereEqualTo(RelationShipContract.TO, cuurUserBasicInfoAVobj);
