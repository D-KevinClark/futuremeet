 ...
 */
public class GoodFriendsFragment extends EndlessSwipeRefreshRecyclerviewFragment {
    ...
    public GoodFriendsFragment() {
        // Required empty public constructor
    }

    public static GoodFriendsFragment newInstance(String param1, String param2) {
    ...
    protected AVQuery<AVObject> initQueryBasic() {
        ...
        query.whereEqualTo(RelationShipContract.TYPE, RelationShipContract.TYPE_BOTH_SIDE);
