...
public class LetterListView extends View {
    ...
    /**
     * this method draw the letters side bar, by calculating the height of the view and the number
     * of the letter so distribute every letter some space equally
     *
     * @param canvas
     */
    @Override
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                showBkg = true;//show black background when user touch the letter side bar
